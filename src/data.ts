...
export const pizzas: Products = [
  ...
  },
  {
    id: 4,
    title: "Kale pomodoro",
    desc: "A combination of italian and healtly food, featuring a  tangy tomato sauce, fresh mozzarella, and a medley of aromatic herbs topped with lettuce, tomatoes, and a serving of crispy kale.",
    img: "/teal/t21.jpg",
    price: 28.9,
    options: [
      {
...
export const singleProduct: Product = {
  id: 1,
  title: "Macaaroons",
  desc: "The classic French dessert, enjoy the cruncy, soft and creamy almond and egg mixture, one that will make you smile and make you powerless to stop from wanting more.",
  img: "/teal/t28.jpg",
  price: 24.9,
  options: [
    {
